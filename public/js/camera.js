...
$(document).ready(function () {
    ...
    // $("#myImg2").attr('src', 'http://admin:gI6TBRMT@10.50.0.110/video/mjpg.cgi?profileid=3');
    // $("#myImg").attr('src', 'http://admin:5OE1zAL7@10.50.0.111/video/mjpg.cgi?profileid=3');
});
