...
<div class="ui container containerPrincipal segment" id="containerToInformations">
    ...
    <div class="ui two column stackable grid">
        ...
        <div class="column">
            {{--  <div class="ui small icon input" >
                <input type="text" placeholder="Pesquisa" id="campo_pesquisa" autocomplete="off" name="campo_pesquisa" style="width: 300px;" autofocus>
                <i class="search icon"></i>
            </div>  --}}
            
            <div class="ui search" style="float: right;">
                <div class="ui icon input">
                    <input class="prompt" type="text" id="campo_pesquisa" name="campo_pesquisa" placeholder="Pesquisa..." style="width: 300px;" autofocus>
                    <i class="search icon"></i>
                </div>
    ...
    <form class="ui form" id="cadastro_condutor" name="cadastro_condutor" method="POST">
        ...
        <div class="ui three column doubling stackable grid">
            ...
            <div class="column" id="d_numero_cartao">
                <div class="field">
                ...
                <div class="field" id="d_tipo_pessoa">
                    ...
                    <span id="msg_erros" class="tipo_pesssoa"></span>
            ...
            <form class="ui form" id="formulario_veiculos">
                ...
                <div class="ui three column doubling stackable grid">
                    ...
                    <div class="column">
                        ...
                        <div class="field" id="d_cor" name="d_cor">
                            <label>Cor:</label>
                        ...
                        <div class="column">
                            ...
                            <div class="field" id="d_ano" style="">
                                ...
                                <div class="ui input left icon">
                                    ...
                                    <input type="year" name="ano" id="ano" min="4" max="5" placeholder="Ano">
                                </div>
...
<link rel="stylesheet" href="{{ asset('libs/css/calendar.min.css') }}">
@endsection
